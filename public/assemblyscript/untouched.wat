(module
 ...
 (data (i32.const 720) "\05\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00\01\t\00\00")
 (table $0 1 1 funcref)
 (elem $0 (i32.const 1))
 ...
 (func $assembly/index/isPrime (param $num i32) (result i32)
  (local $x f64)
  (local $sqrtNum f64)
  (local $i i32)
 ...
 (func $assembly/index/primeFactorization (param $num i32) (result i32)
  (local $primeArr i32)
  (local $arrayI i32)
  (local $i i32)
  (local $4 i32)
